 ...
 */
ULONG
ulGetDataOffset(struct fastbuf *pFile UNUSED)
{
 ...
 */
BOOL
bSetDataOffset(struct fastbuf *pFile, ULONG ulFileOffset)
{
	data_mem_type	*pCurr;
	size_t	tReadLen;
 ...
 */
int
iNextByte(struct fastbuf *pFile)
{
	ULONG	ulReadOff;
	size_t	tReadLen;
 ...
 */
USHORT
usNextWord(struct fastbuf *pFile)
{
	USHORT	usLSB, usMSB;
 ...
 */
ULONG
ulNextLong(struct fastbuf *pFile)
{
	ULONG	ulLSW, ulMSW;
 ...
 */
USHORT
usNextWordBE(struct fastbuf *pFile)
{
	USHORT usLSB, usMSB;
 ...
 */
ULONG
ulNextLongBE(struct fastbuf *pFile)
{
	ULONG	ulLSW, ulMSW;
 ...
 */
size_t
tSkipBytes(struct fastbuf *pFile, size_t tToSkip)
{
