 ...
 */
static void
vSet2DefaultTabWidth(struct fastbuf *pFile, const UCHAR *aucHeader)
{
	UCHAR	*aucBuffer;
 ...
 */
static void
vSet6DefaultTabWidth(struct fastbuf *pFile, ULONG ulStartBlock,
 ...
 */
static void
vSet8DefaultTabWidth(struct fastbuf *pFile, const pps_info_type *pPPS,
 ...
 */
void
vSetDefaultTabWidth(struct fastbuf *pFile, const pps_info_type *pPPS,
	const ULONG *aulBBD, size_t tBBDLen,
	const ULONG *aulSBD, size_t tSBDLen,
