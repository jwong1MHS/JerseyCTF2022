...
/* asc85enc.c */
extern void	vASCII85EncodeByte(struct fastbuf *, int);
extern void	vASCII85EncodeArray(struct fastbuf *, struct fastbuf *, size_t);
extern void	vASCII85EncodeFile(struct fastbuf *, struct fastbuf *, size_t);
/* blocklist.c */
extern void	vDestroyTextBlockList(void);
extern BOOL	bAdd2TextBlockList(const text_block_type *);
extern void	vSplitBlockList(struct fastbuf *, ULONG, ULONG, ULONG, ULONG, ULONG,
			ULONG, ULONG, ULONG, BOOL);
extern BOOL	bExistsTextBox(void);
extern BOOL	bExistsHdrTextBox(void);
extern USHORT	usNextChar(struct fastbuf *, list_id_enum, ULONG *, ULONG *, USHORT *);
...
extern ULONG	ulGetDataOffset(struct fastbuf *);
extern BOOL	bSetDataOffset(struct fastbuf *, ULONG);
extern int	iNextByte(struct fastbuf *);
extern USHORT	usNextWord(struct fastbuf *);
extern ULONG	ulNextLong(struct fastbuf *);
extern USHORT	usNextWordBE(struct fastbuf *);
extern ULONG	ulNextLongBE(struct fastbuf *);
extern size_t	tSkipBytes(struct fastbuf *, size_t);
...
extern BOOL	bTranslateDIB(diagram_type *,
			struct fastbuf *, ULONG, const imagedata_type *);
/* draw.c & output.c */
extern BOOL	bAddDummyImage(diagram_type *, const imagedata_type *);
extern diagram_type *pCreateDiagram(struct fastbuf *);
...
extern BOOL	bGet6DocumentData(struct fastbuf *, ULONG,
				const ULONG *, size_t, const UCHAR *);
/* findtext.c */
extern BOOL	bAddTextBlocks(ULONG , ULONG, BOOL,
				USHORT, ULONG, const ULONG *, size_t);
extern BOOL	bGet6DocumentText(struct fastbuf *, BOOL, ULONG,
				const ULONG *, size_t, const UCHAR *);
extern BOOL	bGet8DocumentText(struct fastbuf *, const pps_info_type *,
...
extern void	vCreate2FontTable(struct fastbuf *, int, const UCHAR *);
extern void	vCreate6FontTable(struct fastbuf *, ULONG,
			const ULONG *, size_t, const UCHAR *);
extern void	vCreate8FontTable(struct fastbuf *, const pps_info_type *,
			const ULONG *, size_t, const ULONG *, size_t,
			const UCHAR *);
...
#endif /* __riscos */
/* imgexam.c */
extern image_info_enum	eExamineImage(struct fastbuf *, ULONG, imagedata_type *);
/* imgtrans */
extern BOOL	bTranslateImage(diagram_type *,
			struct fastbuf *, BOOL, ULONG, const imagedata_type *);
/* jpeg2eps.c & jpeg2spr.c */
extern BOOL	bTranslateJPEG(diagram_type *,
			struct fastbuf *, ULONG, size_t, const imagedata_type *);
/* listlist.c */
...
extern const list_block_type  *pGetListInfoByIstd(USHORT);
/* misc.c */
#if !defined(__riscos)
...
#endif /* DEBUG */
extern BOOL	bReadBytes(UCHAR *, size_t, ULONG, struct fastbuf *);
extern BOOL	bReadBuffer(struct fastbuf *, ULONG, const ULONG *, size_t, size_t,
			UCHAR *, ULONG, size_t);
...
extern void	vGetNotesInfo(struct fastbuf *, const pps_info_type *,
			const ULONG *, size_t, const ULONG *, size_t,
			const UCHAR *, int);
...
/* prop0.c */
extern void	vGet0SepInfo(struct fastbuf *, const UCHAR *);
extern void	vGet0PapInfo(struct fastbuf *, const UCHAR *);
extern void	vGet0ChrInfo(struct fastbuf *, const UCHAR *);
/* prop2.c */
extern void	vGet2SepInfo(struct fastbuf *, const UCHAR *);
...
extern void	vGet2PapInfo(struct fastbuf *, const UCHAR *);
extern void	vGet1FontInfo(int,
			const UCHAR *, size_t, font_block_type *);
extern void	vGet2FontInfo(int,
			const UCHAR *, size_t, font_block_type *);
extern void	vGet2ChrInfo(struct fastbuf *, int, const UCHAR *);
/* prop6.c */
extern void	vGet6SepInfo(struct fastbuf *, ULONG, const ULONG *, size_t,
			const UCHAR *);
extern row_info_enum	eGet6RowInfo(int,
			const UCHAR *, int, row_block_type *);
extern void	vGet6StyleInfo(int,
			const UCHAR *, int, style_block_type *);
extern void	vGet6PapInfo(struct fastbuf *, ULONG, const ULONG *, size_t,
			const UCHAR *);
extern void	vGet6FontInfo(int, USHORT,
			const UCHAR *, int, font_block_type *);
extern void	vGet6ChrInfo(struct fastbuf *, ULONG, const ULONG *, size_t,
			const UCHAR *);
/* prop8.c */
extern void	vGet8SepInfo(struct fastbuf *, const pps_info_type *,
			const ULONG *, size_t, const ULONG *, size_t,
			const UCHAR *);
...
extern void	vGet8StyleInfo(int,
			const UCHAR *, int, style_block_type *);
extern void	vGet8LstInfo(struct fastbuf *, const pps_info_type *,
			const ULONG *, size_t, const ULONG *, size_t,
			const UCHAR *);
extern void	vGet8PapInfo(struct fastbuf *, const pps_info_type *,
			const ULONG *, size_t, const ULONG *, size_t,
			const UCHAR *);
extern void	vGet8FontInfo(int, USHORT,
			const UCHAR *, int, font_block_type *);
extern void	vGet8ChrInfo(struct fastbuf *, const pps_info_type *,
			const ULONG *, size_t, const ULONG *, size_t,
			const UCHAR *);
/* properties.c */
extern void	vGetPropertyInfo(struct fastbuf *, const pps_info_type *,
			const ULONG *, size_t, const ULONG *, size_t,
			const UCHAR *, int);
...
extern void	vGet2Stylesheet(struct fastbuf *, int, const UCHAR *);
extern void	vGet6Stylesheet(struct fastbuf *, ULONG, const ULONG *, size_t,
			const UCHAR *);
extern void	vGet8Stylesheet(struct fastbuf *, const pps_info_type *,
			const ULONG *, size_t, const ULONG *, size_t,
			const UCHAR *);
...
extern void	vSet0SummaryInfo(struct fastbuf *, const UCHAR *);
extern void	vSet2SummaryInfo(struct fastbuf *, int, const UCHAR *);
extern void	vSet6SummaryInfo(struct fastbuf *, const pps_info_type *,
			const ULONG *, size_t, const ULONG *, size_t,
			const UCHAR *);
extern void	vSet8SummaryInfo(struct fastbuf *, const pps_info_type *,
			const ULONG *, size_t, const ULONG *, size_t,
			const UCHAR *);
...
/* tabstop.c */
extern void	vSetDefaultTabWidth(struct fastbuf *, const pps_info_type *,
			const ULONG *, size_t, const ULONG *, size_t,
			const UCHAR *, int);
extern long	lGetDefaultTabWidth(void);
/* text.c */
extern void	vPrologueTXT(diagram_type *, const options_type *);
extern void	vEpilogueTXT(struct fastbuf *);
...
#endif /* !__riscos */
/* word2text.c */
extern BOOL	bWordDecryptor(struct fastbuf *, long, diagram_type *);
/* worddos.c */
extern int	iInitDocumentDOS(struct fastbuf *, long);
/* wordlib.c */
extern BOOL	bIsWordForDosFile(struct fastbuf *, long);
extern BOOL	bIsRtfFile(struct fastbuf *);
extern BOOL	bIsWordPerfectFile(struct fastbuf *);
extern BOOL	bIsWinWord12File(struct fastbuf *, long);
extern BOOL	bIsMacWord45File(struct fastbuf *);
extern int	iGuessVersionNumber(struct fastbuf *, long);
extern int	iGetVersionNumber(const UCHAR *);
extern BOOL	bIsOldMacFile(void);
extern int	iInitDocument(struct fastbuf *, long);
extern void	vFreeDocument(void);
/* wordmac.c */
extern int	iInitDocumentMAC(struct fastbuf *, long);
/* wordole.c */
extern int	iInitDocumentOLE(struct fastbuf *, long);
/* wordwin.c */
extern int	iInitDocumentWIN(struct fastbuf *, long);
/* xml.c */
...
#undef xrealloc
#undef xfree
#define xmalloc(x) parser_malloc(x)
#define xrealloc(x,y) parser_realloc(x,y)
#define xcalloc(x,y) parser_malloc_zero((x)*(y))
#define xfree(x) (ucw_xfree(x), NULL)
