 ...
 */
void
vCreate2FontTable(struct fastbuf *pFile, int iWordVersion, const UCHAR *aucHeader)
{
	FILE	*pFontTableFile;
	font_table_type	*pTmp;
	UCHAR	*aucFont;
 ...
 */
void
vCreate6FontTable(struct fastbuf *pFile, ULONG ulStartBlock,
 ...
 */
void
vCreate8FontTable(struct fastbuf *pFile, const pps_info_type *pPPS,
	const ULONG *aulBBD, size_t tBBDLen,
