 ...
 */
void
vGet0SepInfo(struct fastbuf *pFile, const UCHAR *aucHeader)
{
 ...
 */
void
vGet0PapInfo(struct fastbuf *pFile, const UCHAR *aucHeader)
{
 ...
 */
void
vGet0ChrInfo(struct fastbuf *pFile, const UCHAR *aucHeader)
{
