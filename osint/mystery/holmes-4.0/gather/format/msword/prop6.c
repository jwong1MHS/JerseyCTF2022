 ...
 */
void
vGet6SepInfo(struct fastbuf *pFile, ULONG ulStartBlock,
 ...
 */
void
vGet6PapInfo(struct fastbuf *pFile, ULONG ulStartBlock,
	const ULONG *aulBBD, size_t tBBDLen,
	const UCHAR *aucHeader)
{
	row_block_type		tRow;
 ...
 */
void
vGet6ChrInfo(struct fastbuf *pFile, ULONG ulStartBlock,
