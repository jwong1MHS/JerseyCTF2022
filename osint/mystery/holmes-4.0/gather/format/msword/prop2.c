 ...
 */
void
vGet2SepInfo(struct fastbuf *pFile, const UCHAR *aucHeader)
{
 ...
 */
void
vGet2PapInfo(struct fastbuf *pFile, const UCHAR *aucHeader)
{
	row_block_type		tRow;
 ...
 */
void
vGet2ChrInfo(struct fastbuf *pFile, int iWordVersion, const UCHAR *aucHeader)
{
